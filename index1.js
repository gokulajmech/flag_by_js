let countriesInfo = [
  ...
  // countriesInfo.forEach((countriesInfo)=>console.log(countriesInfo.name));
  countriesInfo.forEach((countriesInfo)=>{
  
  let container=document.createElement('div');
  container.className='set';
  container.innerHTML=`<img class="ger"src=${countriesInfo.flag}>
        <div class="details">
          <p><b class="c-size">${countriesInfo.name}</b></p> 
          
            <b>Population</b> :${countriesInfo.population}
          <br><b>Region</b> :${countriesInfo.region}</br>
            <b>Capital</b> :${countriesInfo.capital}
        </div>
